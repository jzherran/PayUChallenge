			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Aceptar Acción</h4>
					</div>
					<div class="modal-body">
						<p>¿Acepta la eliminación del pasajero?</p>
					</div>
					<div class="modal-footer">
						<a class="btn btn-default" data-dismiss="modal">Cancelar</a>
						<a href="<c:url value='/passenger/delete-12-passenger'/>" 
						class="btn btn-primary" data-dismiss="modal">Aceptar</a>
					</div>
				</div>
			</div>
		</div>
